...
User.create!(name: 'Pillow', image: 'https://giggle-cloud.oss-cn-shanghai.aliyuncs.com/Resources/user1.jpeg', rate: '120rmb/hr', description:"Photography for business events such as weddings, team events and trainings, ", talent: "Photographer", contact: Faker::Internet.email)
User.create!(name: 'Paulo', image: 'https://batch-707.oss-cn-beijing.aliyuncs.com/M-phone-photo2.jpeg', rate: '270rmb/hr', description:"Great at taking pics with my iphone.", talent: "General Photographer", contact: Faker::Internet.email)
User.create!(name: 'Alex', image: 'https://batch-707.oss-cn-beijing.aliyuncs.com/F-holding-camera2.jpeg', rate: '1200 rmb - full day', description:"Full time wedding photographer, with years of experience.  Have some upcoming frees days on Jan 23rd, 25th and 27th", talent: "Wedding Photographer", contact: Faker::Internet.email)
User.create!(name: 'Skylar', image: 'https://batch-707.oss-cn-beijing.aliyuncs.com/F-holding-camera1.jpeg', rate: '300rmb/hr', description:"Experience in combat missions and training programs photography.", talent: "Photographer", contact: Faker::Internet.email)
User.create!(name: 'Oakley', image: 'https://batch-707.oss-cn-beijing.aliyuncs.com/F-holding-camera3.jpeg', rate: '$45/hr', description:"Will do custom photoshop and framing if needed.", talent: "Portrait and Event Photographer", contact: Faker::Internet.email)
User.create!(name: 'Armani', image: 'https://batch-707.oss-cn-beijing.aliyuncs.com/F-holding-camera4.jpeg', rate: '540rmb/hr', description:"Experience with weddings, birthday parties and events, family portaits, etc.", talent: "Photographer", contact: Faker::Internet.email)
